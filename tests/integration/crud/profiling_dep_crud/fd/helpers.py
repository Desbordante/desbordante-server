"""Helper functions for FD profiling dep CRUD tests."""
...
def make_fd_result(
    *,
    ...
    """Build a valid FD result dict for ProfilingDepModel.result."""
    return {
...
def make_query_params(
    *,
    ...
    filters = FdTaskResultFiltersSchema.model_construct(
        search=search or "",
    ...
    query_params = TaskResultQueryParamsSchema[FdTaskResultFiltersSchema](
        filters=filters,
