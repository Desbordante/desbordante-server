...
from internal.dto.repository.file import (DatasetCreateSchema, DatasetUpdateSchema,
                                          DatasetFindSchema, DatasetResponseSchema, FileMetadataResponseSchema,
...
class DatasetRepository(
    ...
    def find_with_file_metadata(
        ...
        stmt = select(DatasetORM).options(joinedload(DatasetORM.file_metadata)).filter_by(**dataset_find_dict)
        ...
        file_metadata_response = FileMetadataResponseSchema.model_validate(dataset_orm_instance.file_metadata)
