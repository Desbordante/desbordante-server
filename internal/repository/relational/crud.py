...
from internal.dto.repository.base_schema import (BaseCreateSchema, BaseUpdateSchema,
                                                 BaseFindSchema, BaseResponseSchema)
from internal.infrastructure.data_storage.relational.context import RelationalContextType
...
class CRUD[
    ...
    def create(self, create_schema: CreateSchema, context: RelationalContextType) -> ResponseSchema:
    ...
    def _find(self, find_schema: FindSchema, context: RelationalContextType) -> ORMModel | None:
    ...
    def find(self, find_schema: FindSchema, context: RelationalContextType) -> ResponseSchema | None:
        db_model_instance = self._find(find_schema, context)
        response = self._response_schema.model_validate(db_model_instance) if db_model_instance else None
        return response
    ...
    def update(
        ...
        fields_to_update_if_none = fields_to_update_if_none if fields_to_update_if_none else set()
    ...
    def delete(self, find_schema: FindSchema, context: RelationalContextType) -> ResponseSchema | None:
        db_model_instance = self._find(find_schema, context)
