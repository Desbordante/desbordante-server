...
from internal.dto.repository.task import TaskUpdateSchema, TaskResponseSchema, TaskFindSchema
...
class UpdateTaskInfo:
    ...
    def __call__(
        ...
        with self.unit_of_work as context:
            try:
                self.task_repo.update(task_find_schema, data_to_update, fields_to_update_if_none, context)
