...
from internal.infrastructure.data_storage.relational.postgres.context import (get_postgres_context_maker,
                                                                              get_postgres_context_maker_without_pool)
from internal.repository.flat import FileRepository
from internal.repository.relational.file import FileMetaDataRepository, DatasetRepository
from internal.repository.relational.task import TaskRepository
from internal.uow import UnitOfWork


def get_unit_of_work(
        context_maker = Depends(get_postgres_context_maker)
) -> UnitOfWork:
