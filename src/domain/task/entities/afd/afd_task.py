...
from src.domain.task.value_objects import PrimitiveName

from src.domain.task.value_objects.afd import AfdTaskResult, AfdTaskConfig
from src.domain.task.value_objects.afd import (
    AfdAlgoName,
    AfdAlgoResult,
    FdModel,
